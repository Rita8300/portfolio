          ...
          <section id="about" className="section">
            ...
            <div className="section-body">
              <p data-reveal style={{ '--reveal-delay': '80ms' }} className="lead">
                福岡大学法学部法律学科で会社法を学びながら、AIやアプリ開発に取り組んでいます。法律を専攻していますが、AIを使って身近な課題を解決し、実際に動くサービスへ落とし込むことに興味を持ったことから、IT分野の学習を始めました。最近は、学生や資格受験者向けの暗記学習アプリ「おぼえこ」を、機能を絞って動くWeb版まで作りました。
              </p>
              ...
              <ul data-reveal style={{ '--reveal-delay': '80ms' }} className="exp-list">
                <li className="exp-item">
                  ...
                  <p className="exp-body">
                    生徒ごとの理解度や苦手分野を確認し、説明方法や問題の難易度を調整。相手の反応を見ながら伝え方を変える経験を積んだ。
                  </p>
                </li>
                <li className="exp-item">
                  <h3 className="exp-role">歴史学研究会</h3>
                  <p className="exp-body">
                    参加者の減少によって廃部の可能性があった団体で、企画や勧誘方法を改善。歴史に詳しい学生だけを対象にせず、文化祭でのクイズ企画や遺跡見学旅行など、初めてでも興味を持ちやすい活動を取り入れた。部内で役割を分担し、参加者の反応を見ながら内容や運営を改善。参加の心理的なハードルを下げることを意識して周知方法も工夫し、登録者を含めて約30人が参加する団体へと立て直した。相手の立場から参加しにくい原因を考え、入口を設計することの重要性を学んだ。
                  </p>
                </li>
                <li className="exp-item">
                  <h3 className="exp-role">会社法ゼミ</h3>
                  <p className="exp-body">
                    判例について2〜3人のグループで調査し、内容を整理して発表。質問への対応を通じて、根拠を示しながら説明する力を磨いている。
                  </p>
                </li>
                <li className="exp-item">
            ...
            <div className="section-body">
              <div data-reveal style={{ '--reveal-delay': '80ms' }} className="grid">
                <div className="card">
                  <h3>相手に合わせて工夫できる</h3>
                  <p>
                    家庭教師の経験から、相手の理解度や性格に合わせて説明方法を変える力を身につけた。一方的に教えるのではなく、どこでつまずいているのかを確認し、言葉や例を変えながら理解につなげてきた。
                  </p>
                </div>
                <div className="card">
                  <h3>組織の課題を発見し、立て直せる</h3>
                  <p>
                    廃部寸前だった歴史学研究会の立て直しに取り組んだ。歴史に詳しい人だけを対象にせず、文化祭でのクイズ企画や遺跡見学旅行など、初めてでも参加しやすい活動を増やした。その結果、登録者を約30人まで増やした。
                  </p>
                </div>
                <div className="card">
