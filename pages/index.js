            ...
            <div className="section-body">
              <ul data-reveal style={{ '--reveal-delay': '80ms' }} className="exp-list">
                ...
                <li className="exp-item">
                  ...
                  <p className="exp-body">
                    現役部員が一桁にとどまり、上級生の卒業後は運営を続けにくい状況だった団体で、課題整理と企画設計を担当。「歴史に詳しい人しか入れない」という団体名の堅い印象が入り口を狭くしていると考え、文化祭の歴史クイズは初心者から歴史好きまで楽しめるよう3段階の難易度で自作し、遺跡見学旅行は「遠出したいが一人では踏み出せない」という友人の声から企画した。運営はメンバー全員で担いながら、登録・参加希望者を含めて約30人規模まで増やすことができた。相手が動かない理由を興味の不足と決めつけず、入り口を設計することの重要性を学んだ。
                  </p>
                </li>
                <li className="exp-item">
            ...
            <div className="section-body">
              <div data-reveal style={{ '--reveal-delay': '80ms' }} className="grid">
                ...
                <div className="card">
                  ...
                  <p>
                    現役部員が一桁だった歴史学研究会で、課題整理と企画設計を担当。歴史に詳しい人だけを対象にせず、初心者から楽しめる歴史クイズや遺跡見学旅行など、参加しやすい入り口を増やした。運営はメンバー全員で担い、登録・参加希望者を含めて約30人規模まで増やすことができた。
                  </p>
                </div>
                <div className="card">
